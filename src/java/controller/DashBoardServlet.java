...
public class DashBoardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("numOfProduct", db.getNumberOfProduct());
        request.setAttribute("numOfCustomer", db.getNumberOfCustomer());
        request.setAttribute("numOfOrder", db.getNumberOfOrder());
        request.setAttribute("totalRevenue", db.getTotalRevenueThisMonth());
        request.setAttribute("potentialCustomer", db.getPotentialCustomers());
//Chart
        if (chartOption == null) {
