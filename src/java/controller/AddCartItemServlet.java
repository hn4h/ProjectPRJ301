...
public class AddCartItemServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String productItemID_raw = request.getParameter("shoe-size");
        String quantity_raw = request.getParameter("product-quantity");
        String id_raw = request.getParameter("id");
        // System.out.println(productItemID_raw);
        //     System.out.println(quantity_raw);
        //     System.out.println(id_raw);
        try {
            int id = Integer.parseInt(id_raw);
            int productItemID = Integer.parseInt(productItemID_raw);
            int quantity = Integer.parseInt(quantity_raw);
            CartDAO dao = new CartDAO();
            dao.addCartItem((int) request.getSession().getAttribute("accountID"), productItemID, quantity);
            response.sendRedirect("/project/product?id=" + id);
